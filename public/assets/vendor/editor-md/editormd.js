...
;(function (factory) {
    ...
    editormd.defaults = {
        ...
        imageUpload: false,
        imageFormats: ["webp", "jpg", "jpeg", "gif", "png", "bmp", "webp"],
        imageUploadURL: "",
            ...
            if (atLinkReg.test(text)) {
                ...
                if (settings.emailLink) {
                    text = text.replace(emailLinkReg, function ($1, $2, $3, $4, $5) {
                        return (!$2 && $.inArray($5, "webp|jpg|jpeg|png|gif|webp|ico|icon|pdf".split("|")) < 0) ? "<a target=\"_blank\" href=\"mailto:" + $1 + "\">" + $1 + "</a>" : $1;
                    });
                }
    ...
    editormd.codeHighlight = function(obj) {
        if (typeof prettyPrint !== "undefined") {
            ...
            prettyPrint();
            // 编辑状态下不添加复制按钮
            if(!obj.hasClass('editormd-preview-container') && !location.href.endsWith('markdown.pdf')) {
