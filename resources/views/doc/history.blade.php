                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ wzRoute('project:doc:history:show', ['id' => $project->id, 'page_id' => $pageItem->id, 'history_id' => $history->id]) }}">
                                <i class="fa fa-eye" data-bs-toggle="tooltip" title="@lang('common.btn_view')"></i>
                            </a>
                            ...
                            @can('page-edit', $pageItem)
                                <a href="#" wz-form-submit data-form="#form-recover-{{ $history->id }}"
                                   data-confirm="@lang('document.recover_confirm')">
                                    <i class="fa fa-rotate-left" data-bs-toggle="tooltip" title="@lang('document.btn_recover')"></i>
                                </a>
