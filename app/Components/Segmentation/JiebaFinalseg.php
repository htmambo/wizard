...
class JiebaFinalseg
{
    ...
    public static function init($options = array())
    {
        ...
        self::$prob_start = self::loadModel(__DIR__ . '/model/prob_start.json');
        self::$prob_trans = self::loadModel(__DIR__ . '/model/prob_trans.json');
        self::$prob_emit = self::loadModel(__DIR__ . '/model/prob_emit.json');
